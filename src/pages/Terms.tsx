                ...
                <div className="flex flex-col rounded-20 items-center bg-gr-purple-light text-white space-y-7 py-5 pb-16 px-4 md:px-8">
                    ...
                    <div>
                        <h1 className="text-base font-bold font-jkarta text-white md:text-xl">
                            By using Zian AI, or creating or paying for an account, or accessing any of the webpages hosted on zian.ai, you acknowledge that you have read, understood, and agreed to be bound by these terms.                        </h1>
                    </div>
                </div>
            </GrBorderBox>
        </div>
